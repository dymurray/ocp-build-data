...
ENV __doozer=update __doozer_group=rhel-9-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.7-20260217.095550 __doozer_version=v1.25.7 
...
LABEL \
        ...
        release="202602170955.g5015a16.el9" \
        io.openshift.build.commit.id="5015a1635be8623c2c550777e11f6bd45450218c" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/5015a1635be8623c2c550777e11f6bd45450218c" \
